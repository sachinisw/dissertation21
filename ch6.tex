...
Table~\ref{tab:summarycontrolcondition} summarizes the analysis of the use of Interactive Human-aware Intervention during a Rush Hour planning task using the four evaluation metrics.
...
I think reducing the number of planning tasks to one each from the categories C, E, M will help us yield more conclusive results on the effects of the Interactive Human-aware Intervention.
